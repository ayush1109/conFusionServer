...
.options(cors.corsWithOptions, (req, res) => {res.sendStatus(200); })
    ...
    .put(cors.corsWithOptions, authenticate.verifyUser, authenticate.verifySame, (req, res, next) => {
    ...
    .delete(cors.corsWithOptions, authenticate.verifyUser, authenticate.verifySame, (req, res, next) => {
        Dishes.findById(req.params.dishId)
            .then((dish) => {
                if (dish != null && dish.comments.id(req.params.commentId) != null) {
